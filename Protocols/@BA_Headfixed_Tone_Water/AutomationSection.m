...
switch action
    ...
    case 'prepare_next_trial',
        ...
        if (strcmp(BEGINNER,'No') && strcmp(ADAPTIVE, 'Off')) ...
                ||  size([parsed_events.states.trial_timed_out],1) == 1, 
            %BA if trial timed out don't change anything
        ...
        %if not fake poke
            ...
            if isempty(combined_waiting_large),
                ...
                if size([parsed_events.states.waiting1_np],1) == 1,
                    ...
                    sorted_waiting1 = ...
                        sort([parsed_events.states.waiting1_np],1);
