...
function [sma] = StateMachineAssembler(varargin)
   ...
   default_output_map = { ...
     'DOut'       15 ; ...
     'SoundOut'   16 ; ... This is column of the state matrix use this number down there
   };
   ...
   sma = struct( ...
     ...
     'current_state',       0,             ...
     ...'states',              zeros(0, 10),  ...
     'states',              zeros(0, 16),  ... down here!! Add here correct number of columns of the state matrix
     'default_actions',     {cell(0, 1)},  ...
     'current_iti_state',   0,             ...
     ...'iti_states',          zeros(0, 10),  ...
     'iti_states',          zeros(0, 16),  ... and here!! Add here correct number of columns of the state matrix
