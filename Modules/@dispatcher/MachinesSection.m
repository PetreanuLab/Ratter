...
switch action,
  ...
  case 'init'
    ...
    try   server_slot.value = Settings('get', 'RIGS', 'server_slot');
    catch 
    end;
    if isnan(value(server_slot)), server_slot.value = 0; end;
    try   card_slot.value = Settings('get', 'RIGS', 'card_slot');
    catch 
    end;
  ...
  case 'close', 
    ...
    case 'determine_io_maps',
        lone_rig=Settings('compare','RIGS','lone_rig','1');
        ...
        elseif lone_rig==1,
            ...
            [input_lines  errIL  msgIL ] = Settings('get','INPUTLINES','all');
            [IL_offset    errILO       ] = Settings('get','INPUTLINES_MISC','offset');
        ...
        elseif lone_rig==1,
            ...
            [dout_lines errOL  msgOL ] = Settings('get','DIOLINES','all');
            [OL_offset    errOLO       ] = Settings('get','DIOLINES_MISC','offset');
