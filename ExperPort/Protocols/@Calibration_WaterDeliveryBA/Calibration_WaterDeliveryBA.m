...
%         
        ...
        [center_valve errC]   = Settings('get','DIOLINES','center1water');
        [center_led   errC2]  = Settings('get','DIOLINES','center1led');
...
%             end;
            if ~errC,
                sma = add_state(sma, ...
                    ...
                    'output_actions', {'DOut', Settings('get', 'DIOLINES','HF1water')}, ...
                    'input_to_statechange', {'Tup', 'current_state+1'});
