...
%     DispParam(obj, 'odorPresent', 'No', x, y, 'label', ' Odor Present'); next_row(y,1);
    ...
    NumEditParam(obj, 'conc1', 0, x, y, 'label', 'Concentration 1'); next_row(y,1);
    NumEditParam(obj, 'conc2', 0, x, y, 'label', 'Concentration 2'); next_row(y,1);
    NumEditParam(obj, 'conc3', 0, x, y, 'label', 'Concentration 3'); next_row(y,1);
    NumEditParam(obj, 'conc4', 0, x, y, 'label', 'Concentration 4'); next_row(y,1);
    NumEditParam(obj, 'conc5', 0, x, y, 'label', 'Concentration 5'); next_row(y,1.5);
    ...
    DispParam(obj, 'correctChoiceConc5', 0, x, y, ...
        'label', 'Correct', 'labelfraction', 0.5); next_row(y,1.5);
...
%     concentrations(1,5) = 0.1;
    ...
    odorConcVector.value = zeros(1,1000);
...
%     odorValvesOpening(1,:) = rand (1,1000) < value(probYesValve);
   ...
   case 'setOdorConcVector'
        if value(conc1)~=0 && value(conc2)==0 && value(conc3)==0 && value(conc4)==0 && value(conc5)==0
       ...
       elseif value(conc1)~=0 && value(conc2)~=0 && value(conc3)~=0 && value(conc4)~=0 && value(conc5)==0
        ...
        for i = 1 : Lconcentrations
            odorConcVector(value(LodorConcVector)/2*(1+(i-1)/Lconcentrations)+1 : ...
                value(LodorConcVector)/2*(1+i/Lconcentrations)) = value(concentrations(1,i)); 
...
%         odorConcVector(value(LodorConcVector)/2+1 : value(LodorConcVector)/2+value(LodorConcVector)/2*4/Lconcentrations) = value(concentrations(1,4)); 
        ...
        odorConcVector.value = value(odorConcVector(p));
...
%     end
    ...
    elseif value(odorConcVector(1,n_started_trials+1) == 0) ...
