...
%     DispParam(obj, 'nTrials', 0, x, y);
 ...
 % ----------------  ProtocolPhaseSection --------------------
    ...
    my_state_colors = struct( ...
        ...
        'lin_water_olf',      	       [0.5 1 0.75],   ...
        'rin_water_olf',      	       [0 0 0.5],   ...
        'lin_no_water_olf',      	   [0 0 1],   ...
        'rin_no_water_olf',      	   [0 0.5 0],   ...
        'final_state',      	   [0.4 1 0]);%   ...
...
%   Next two lines set the Xaxis limits for the PokesPlot (don't understand them compleatly but thanks to Santiago Jaramillo's protocol)  
    ...
    NumeditParam(obj, 'weight', 0, x, y, 'label', 'Weight (g)');next_row(y);
    EditParam(obj, 'strain', 'LE', x, y, 'label', 'Strain');next_row(y);
    NumEditParam(obj, 'initialWeight', 0, x, y, 'label', 'Initial weight (g)');next_row(y,1);
...
%     DispParam(obj, 'rValve', 0.106, x, y, 'label', 'Right valve open time');next_row(y);
%     DispParam(obj, 'lValve', 0.113, x, y, 'label', 'Left valve open time');next_row(y,1.5);
%     NumEditParam(obj, 'probRvalve', 0.2, x, y, 'label', 'Prob. right valve');next_row(y);
%     NumEditParam(obj, 'probLvalve', 0.8, x, y, 'label', 'Prob. left
%     valve');next_row(y,1.5)

%     [x, y] = ChoiceSection(obj, 'init', x, y); next_row(y, 1.5)
...
%    AutomationSection(obj, 'init');
  ...
  % cases...
   ...
   case 'prepare_next_trial'
    ...
    ProtocolPhaseSection(obj, 'next_trial');
...
%     AutomationSection(obj, 'next_trial');   
...
%        disp(n_done_trials)
  ...
  %---------------------------------------------------------------
  case 'update'
    ProtocolPhaseSection(obj, 'update')
