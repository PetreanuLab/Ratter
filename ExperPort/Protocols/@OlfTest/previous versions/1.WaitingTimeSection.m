...
switch action
    ...
    case 'init',
        ...
        fig = gcf; %main figure of olfprotocol
        ...
        set_callback(ProtocolPhase, {'WaitingTimeSection', 'switch'});
        SubHeaderParam(obj, 'WaitingTimeSection', 'WaitingTime Section', x, y);
        next_row(y);
        oldx = x; oldy = y;     
...
%     if strcmp(value(ProtocolPhase), 'water at the lateral pokes') == 1 || strcmp(value(ProtocolPhase), 'olfaction') == 1
