...
switch action,
    ...
    case 'init',
        ...
        % %     %     if ismember(Settings('get','RIGS','fake_rp_box'), [3 4]) || ismember(fake_rp_box, [3 4]),
    ...
    case 'RunLoop',
        ...
        if ~Settings('compare','GENERAL','use_timers',0),
    ...
    case 'update',
        ...
        if ismember(Settings('get','RIGS','fake_rp_box'),[3 4]),
...
[run_third_party_scripts errID1] = ...
    Settings('compare','AUX_SCRIPT','Disable_Aux_Scripts', false);
[run_script_on_this_hook errID2] = ...
    Settings('compare','AUX_SCRIPT',['Enable_' hook '_Script'], true); %e.g. Enable_On_Run_Script
[script_to_run errID3] = ...
    Settings('get','AUX_SCRIPT',[hook '_Script']);
[script_args errID4] = ...
    Settings('get','AUX_SCRIPT',[hook '_Args']);
