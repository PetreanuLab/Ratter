% [sph] = SliderParam(obj, parname, parval, min, max, x, y, {'position', gui_position(x, y)}, ...
...
% 'slider' (a horizontal slider that has a numeric value). 
%
% RETURNS:
% --------
%
...
% ---------
%
% >> SliderParam('base', 'this', 49, 0.1, 60, 5, 5, 'TooltipString', 'gee!')
...
%        >> value(this)
%
% >> SliderParam('base', 'this', 49, 0.1, 60, 5, 5, 'labelpos', 'left')
