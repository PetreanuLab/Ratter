...
switch action,
  ...
  case 'add'  
    ...
    NumeditParam(obj, [tname '_Max'], Max, x, y, 'label','Max', 'TooltipString', ' Max in s',   'position', [x+72 y 70 20], 'labelfraction', 0.4); next_row(y);
    ...
    MenuParam(obj, [tname '_Style'], {'uniform', 'exponential', 'gaussian'}, Style, x, y, 'label', 'Style', 'labelfraction', 0.3, 'TooltipString', ' form of distribution from which samples are taken', ...
