...
try
    ...
    switch action
        ...
        case 'init'
            ...
            SoloParamHandle(obj, 'MAIN_DATA_DIRECTORY', 'value', Settings('get', 'GENERAL', 'Main_Data_Directory'));
            ...
            SoloParamHandle(obj, 'MAIN_CODE_DIRECTORY', 'value', Settings('get', 'GENERAL', 'Main_Code_Directory'));
        ...
        case 'btnReloadCallback'
            ...
            if ~isempty(value(CURRENT_TRAINING_STAGES_FILE_PATH))
                ...
                %repository
                cvsroot_string = Settings('get', 'CVS', 'CVSROOT_STRING');
...
Main_Data_Directory = Settings('get', 'GENERAL', 'Main_Data_Directory');
