...
% compute_next_trial -- SessionDefinition(obj, 'compute_next_trial')
%   Used to evaluate the currently active training stage and the
%   corresponding completion test. If completion test evaluates to true,
