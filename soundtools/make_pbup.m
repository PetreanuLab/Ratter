...
% inputs:
%
%	R		total rate of bups from both left and right speakers (r_L + r_R)
%			note that if distractor_rate > 0, then R includes these stereo
%			distractor bups as well
%
%	g		the log ratio of right and left rates: log(r_R/r_L)
%
%	srate	sample rate
%
...
%
% bup_width
%			width of a bup in msec
% base_freq       
%           base frequency of an individual bup. The individual bup
...
%           basefreq combined with ntones-1 higher octaves.
% 
% bup_ramp        
