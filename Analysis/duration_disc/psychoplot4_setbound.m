function [yhat] = psychoplot4_setbound(beta,x,varargin)
...
if constrain_bounds > 0
    ...
    [L H] = psychoplot4_sp('get_lims');
    if L == 0, L = 0.001; end;
    K =H/L;

    x= x-(psychoplot4_sp('get_bin_midpoint'));
    ...
    switch usefunction
        case 'general_logistic'
            ...
            if isnan(binrange_mp)
                binrange_mp = psychoplot4_sp('get_bin_midpoint');
            end;
