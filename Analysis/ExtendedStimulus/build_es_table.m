function estr=build_es_table(f)
...
mysqlstr1='create table protocol.extendedstimulus (sessid int not null, trial_n int(6) not null, ProtocolsSection_parsed_event blob, '; 
