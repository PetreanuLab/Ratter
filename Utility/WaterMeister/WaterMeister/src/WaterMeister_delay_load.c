 ...
 */
FARPROC WINAPI WaterMeisterDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = WaterMeisterDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = WaterMeisterDelayLoadWin32FailureHook;
#endif
