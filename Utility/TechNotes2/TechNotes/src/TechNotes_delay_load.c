 ...
 */
FARPROC WINAPI TechNotesDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = TechNotesDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = TechNotesDelayLoadWin32FailureHook;
#endif
